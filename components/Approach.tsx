  ...
  return (
    <section id="approach" className="w-full py-20">
      ...
      <Card
          ...
          description="We'll work together to outline your website's objectives, target audience, and essential features. We'll cover aspects such as site structure, navigation, and content needs."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Once we finalize the plan, I put on my lofi playlist and get to work on coding. From initial sketches to refined code, I keep you informed at every stage."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="This is where the magic happens! Using the approved design, I'll convert everything into functional code, constructing your website from the ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
